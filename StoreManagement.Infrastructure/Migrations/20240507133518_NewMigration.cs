        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Last_Modify_Time = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Last_Modify_Time = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Last_Modify_By = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Email_Token = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Token_Revoked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubCategorys_Category_Category_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_SubCategorys_SubCategory_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_Is_Deleted",
                table: "OrderProducts",
                column: "Is_Deleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategorys_Category_Id",
                table: "SubCategorys",
                column: "Category_Id");

            migrationBuilder.CreateIndex(
                name: "IX_SubCategorys_Is_Deleted",
                table: "SubCategorys",
                column: "Is_Deleted");
        }
